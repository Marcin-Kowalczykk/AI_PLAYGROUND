export const TASK_NAME = 'kategorie'

export const ALL_EXTRACTED_FILES_RESULTS = [
  {
  ...
  },
  {
    ...
    content:
      'Boss! Znalazliśmy jednego gościa, który siedział za brzegiem brzegu. Rozmawiał z kimś, który posiadał urządzenie alarmowe. Nie powiedział, co robił tutaj, czy kto był. Został zatrzymany. Po tym wypadku, zespół wrócił na patrolę okoliczności.',
  },
]
